...
class ReportsPanel(ctk.CTkFrame):
    ...
    def _build(self):
        ...
        self.btn_export = ctk.CTkButton(
            actions_row, text="Export CSV", width=100, height=32,
        ...
        self.btn_refresh = ctk.CTkButton(
            actions_row, text="Refresh", width=80, height=32,
        ...
        self._test_scroll = ctk.CTkScrollableFrame(self._test_tab, fg_color="transparent")
        self._test_scroll.pack(fill="both", expand=True)

        self._event_scroll = ctk.CTkScrollableFrame(self._event_tab, fg_color="transparent")
    ...
    def _fill_test_results(self):
        ...
        # Header Row
        header = ctk.CTkFrame(self._test_scroll, fg_color=("gray95", "gray25"), corner_radius=6)
        header.pack(fill="x", pady=(0, 6))
        for col, w in [("Timestamp", 140), ("Test Name", 200), ("Outcome", 70), ("Summary Steps Details", 0)]:
            ctk.CTkLabel(
                header,
                text=col,
                width=w,
    ...
    def _fill_events(self):
        ...
        # Header Row
        header = ctk.CTkFrame(self._event_scroll, fg_color=("gray95", "gray25"), corner_radius=6)
        header.pack(fill="x", pady=(0, 6))
        for col, w in [("Timestamp", 140), ("Severity", 80), ("Event Description Message", 0)]:
            ctk.CTkLabel(
                header,
                text=col,
                width=w,
